...
constexpr char kWindowTitle[] = "LE2A_03_クラタ_ユウキ_MT3_01_00";
constexpr int kWindowWidth = 1280;	// ウィンドウの幅
constexpr int kWindowHeight = 720;	// ウィンドウの高さ
